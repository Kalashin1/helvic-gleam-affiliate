    ...
    <div className="main-sidebar sidebar-style-2">
      <aside id="sidebar-wrapper">
        ...
        <ul className="sidebar-menu">
          ...
          <li className="dropdown">
            <a href="!#" className="menu-toggle nav-link has-dropdown"><i data-feather="pic"></i><span>Gallery</span></a>
            <ul className="dropdown-menu">
          ...
          <li className="dropdown active">
            ...
            <ul className="dropdown-menu">
              ...
              <li className="active"><a className="nav-link" href="invoice.html">Invoice</a></li>
            </ul>
          </li>
          <li className="dropdown">
            <a href="!#" className="menu-toggle nav-link has-dropdown"><i
